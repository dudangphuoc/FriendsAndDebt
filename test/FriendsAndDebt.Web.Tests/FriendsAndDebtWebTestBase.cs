...
using FriendsAndDebt.Models.TokenAuth;
...
{
    public abstract class FriendsAndDebtWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FriendsAndDebtWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FriendsAndDebtWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FriendsAndDebtDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FriendsAndDebtDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FriendsAndDebtDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FriendsAndDebtDbContext, Task<T>> func)
        {
            T result;
