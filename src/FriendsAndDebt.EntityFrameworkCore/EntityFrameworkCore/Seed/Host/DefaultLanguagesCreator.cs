...
namespace FriendsAndDebt.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = FriendsAndDebtConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FriendsAndDebtDbContext context)
        {
            _context = context;
        }
